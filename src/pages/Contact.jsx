...
const Contact = () => {
  const socialLinks = [
    {
      name: 'Twitter',
      url: 'https://twitter.com/SamarthS_1101',
      icon: (
    ...
    {
      name: 'GitHub',
      url: 'https://github.com/samarthSrivastavaa',
      icon: (
        <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
    ...
    {
      name: 'LinkedIn',
      url: 'https://www.linkedin.com/in/samarth-srivastava-426051283',
      icon: (
        <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
    ...
    {
      name: 'Discord',
      url: 'https://discord.com/users/samarth#1234',
      icon: (
        <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
  ...
  return (
    <div id="contact" className="bg-black text-white py-20 overflow-x-hidden">
      <div className="max-w-4xl mx-auto px-6 text-center">
        ...
        >
          ...
          {/* Email */}
          <div className="inline-flex items-center gap-3 bg-gray-900/50 border border-gray-800 rounded-lg px-6 py-4 mb-8">
            <svg className="w-5 h-5 text-blue-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 8l7.89 4.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
            </svg>
            <a 
              href="mailto:samarthsrivastava897@gmail.com"
              className="text-blue-400 hover:text-blue-300 transition-colors duration-200 font-medium"
            >
              samarthsrivastava897@gmail.com
            </a>
          </div>
        </motion.div>
        ...
        >
          ...
          <span>I typically respond within 30 Minutes!</span>
        </motion.div>
      </div>
    </div>
  )
