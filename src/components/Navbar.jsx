...
const Navbar = () => {
  return (
     ...
     <div className='pt-16 ml-6 flex space-x-40 items-center'>
        <div className='text-[20px] font-bold tracking-wider font-poppins'><span className='font-bold text-[25px] text-cyan-200 inline-block pb-0.5 border-white/40 text-white/90 hover:text-white hover:border-white transition-colors duration-200'>SAMARTH SRIVASTAVA</span></div>
